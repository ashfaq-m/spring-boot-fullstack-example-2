...
class CustomerJDBCDataAccessAndServiceTest extends AbstractTestContainerUnitTest {

    private CustomerJDBCDataAccessAndService underTest;
    private final CustomerRowMapper customerRowMapper = new CustomerRowMapper();

    @BeforeEach
    void setUp() {

        underTest = new CustomerJDBCDataAccessAndService(
                getJdbcTemplate(),
                customerRowMapper
        );
    }
    ...
    @Test
    void existsPersonWithEmailReturnFalseWhenDoesNotExits() {
        // Given
        String email = FAKER.internet().safeEmailAddress() + "-" + UUID.randomUUID();
    ...
    @Test
    void existsCustomerWithIdReturnFalseWhenDoesNotExits() {
        // Given
        int id = -1;
